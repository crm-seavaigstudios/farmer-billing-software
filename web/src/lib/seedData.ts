...
export const INITIAL_PRODUCTION_FARMERS = [
  { id: 'far-01', farmerIdCode: 'FAR-01', name: 'Ramesh Patil', phone: '9823456789', village: 'Nandgaon', taluka: 'Nashik', grade: 'A Grade', totalPurchase: 124500, totalPaid: 95000, advanceBalance: 15000, outstandingAmount: 14500, bankName: 'State Bank of India', accountNumber: '30987654321', ifscCode: 'SBIN0001234' },
  { id: 'far-02', farmerIdCode: 'FAR-02', name: 'Suresh Jadhav', phone: '9765432100', village: 'Yeola', taluka: 'Yeola', grade: 'A Grade', totalPurchase: 85000, totalPaid: 85000, advanceBalance: 0, outstandingAmount: 0, bankName: 'Bank of Baroda', accountNumber: '40123456789', ifscCode: 'BARB0YEOLAX' },
  { id: 'far-03', farmerIdCode: 'FAR-03', name: 'Vijay Shinde', phone: '8856789123', village: 'Pimpalgaon', taluka: 'Niphad', grade: 'B Grade', totalPurchase: 42000, totalPaid: 32000, advanceBalance: 5000, outstandingAmount: 5000, bankName: 'HDFC Bank', accountNumber: '50198765432', ifscCode: 'HDFC0000987' },
  { id: 'far-04', farmerIdCode: 'FAR-04', name: 'Ganesh More', phone: '9761112345', village: 'Chandwad', taluka: 'Chandwad', grade: 'A Grade', totalPurchase: 156000, totalPaid: 120000, advanceBalance: 20000, outstandingAmount: 16000, bankName: 'ICICI Bank', accountNumber: '60123456789', ifscCode: 'ICIC0000456' },
  { id: 'far-05', farmerIdCode: 'FAR-05', name: 'Sunil Pawar', phone: '9098765432', village: 'Sinnar', taluka: 'Sinnar', grade: 'A Grade', totalPurchase: 98000, totalPaid: 75000, advanceBalance: 10000, outstandingAmount: 13000, bankName: 'Axis Bank', accountNumber: '70198765432', ifscCode: 'UTIB0000789' },
  { id: 'far-06', farmerIdCode: 'FAR-06', name: 'Ajay Deshmukh', phone: '9823001122', village: 'Nandgaon', taluka: 'Nashik', grade: 'B Grade', totalPurchase: 34000, totalPaid: 34000, advanceBalance: 0, outstandingAmount: 0, bankName: 'Maharashtra Gramin Bank', accountNumber: '80123456789', ifscCode: 'MAHG0000321' },
];
